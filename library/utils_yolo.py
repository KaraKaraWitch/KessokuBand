"""Utility functions for yolo styled models. Taken from https://huggingface.co/spaces/deepghs/anime_object_detection/blob/main/yolo_.py"""
...
def output_postprocess(output, conf_threshold, iou_threshold, old_size, new_size, labels: List[str]):
