"""
kara_skytnt_aesthetic: skytnt aesthetic rating. (Normalized from 0 to 100) 
"""
import click
    ...
    with tqdm.tqdm(
        ...
        for file in distortion.folder_images(folder_path):
            ...
            if not no_mixin:
                ...
                root = {**root, "st_aesthetic": general}
            else:
                root = {"st_aesthetic": general}
